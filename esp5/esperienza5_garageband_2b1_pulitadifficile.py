...
data2, samplerate2=sf.read('./pulita_difficile.wav')
...
plt.title('Waveform 4: Pulita difficile', size=30)
...
fig.suptitle('Fourier Analysis: Pulita difficile', fontsize=25, y=1)
ax[0].set_title('Parte reale', fontsize=25)
ax[0].plot(freq2[:len(freq2)//2], r2[:len(r2)//2], color='red')
ax[0].grid(linestyle=':')
...
ax[1].plot(freq2[:len(freq2)//2], i2[:len(i2)//2], color='red')
ax[1].grid(linestyle=':')
...
ax[2].plot(freq2[:len(freq2)//2], p2[:len(p2)//2], color='red')
ax[2].grid(linestyle=':')
...
plt.figure()
plt.title('Pulita difficile: Spettro di potenza normalizzato', fontsize=25)
plt.plot(freq2[:len(freq2)//2], p2_norm[:len(p2)//2], color='red', marker='*')
plt.grid(linestyle=':')
plt.xlim(-50, 3500)
...
ax[0].plot(freq2[:len(freq2)//2], p2_norm[:len(p2)//2], color='red', marker='*')
ax[0].grid(linestyle=':')
ax[0].set_xlabel('Frequenza (Hz)', fontsize=20)
ax[0].set_ylabel('|C_k|^2 norm', fontsize=20)
ax[0].set_xlim(81, 84)
ax[0].set_ylim(-0.005, 0.075)
ax[1].set_title('La', fontsize=25)
ax[1].plot(freq2[:len(freq2)//2], p2_norm[:len(p2)//2], color='red', marker='*')
ax[1].grid(linestyle=':')
ax[1].set_xlabel('Frequenza (Hz)', fontsize=20)
ax[1].set_xlim(108, 112)
ax[1].set_ylim(-0.01, 0.195)
ax[2].set_title('Si', fontsize=25)
ax[2].plot(freq2[:len(freq2)//2], p2_norm[:len(p2)//2], color='red', marker='*')
ax[2].grid(linestyle=':')
ax[2].set_xlim(245, 251)
ax[2].set_ylim(-0.03, 0.63)
ax[2].set_xlabel('Frequenza (Hz)', fontsize=20)
ax[3].set_title('Do#', fontsize=25)
ax[3].plot(freq2[:len(freq2)//2], p2_norm[:len(p2)//2], color='red', marker='*')
ax[3].grid(linestyle=':')
ax[3].set_xlim(276, 279)
ax[3].set_ylim(-0.007, 0.08)
