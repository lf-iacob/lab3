...
ax[0].plot(freq2[:len(freq2)//2], r2[:len(freq2)//2], color='mediumvioletred')
ax[0].grid(linestyle=':')
...
ax[1].plot(freq2[:len(freq2)//2], i2[:len(freq2)//2], color='mediumvioletred')
ax[1].grid(linestyle=':')
...
ax[2].plot(freq2[:len(freq2)//2], p2[:len(freq2)//2], color='mediumvioletred')
ax[2].grid(linestyle=':')
...
plt.plot(freq2[:len(freq2)//2], p2_norm[:len(p2_norm)//2], color='mediumvioletred', marker='*')
plt.grid(linestyle=':')
