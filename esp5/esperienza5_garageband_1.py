...
print("La riproduzione è avvenuta con successo.")
...
'''
Si osservi che il primo segnale è una sinusoide palese, per cui il fit non avrebbe significato e nemmeno senso:
c'è un'unica armonica già nota, basta quel termine per conoscere il segnale per intero.
Nel caso Data2, invece, si studia l'andamento dello spettro. Ovviamente, si guardano i valori già filtrati dal rumore in seno.
...
plt.text(20, 1e12, 'y=k/f^b => k: {:} \n                    b={:}'.format('{:.2e}'.format(par2[0]), round(par2[1], 3)), fontsize=16, color='black', alpha=0.7)
plt.show()
