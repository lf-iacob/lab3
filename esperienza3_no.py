...
#Realizzazione del grafico (oscilloscopio: riferimento al primo csv)
plt.figure(figsize=(12,4))
plt.plot(o_t11[100:1100], v11[100:1100], color='springgreen', marker='.')
...
#Grafico per estrarre g: lineare
plt.figure(figsize=(13,7))
plt.errorbar(x, l*100, xerr=err_x, yerr=err_l*100, color='teal', fmt='.', markersize=0)
...
plt.errorbar(x, l*100, xerr=err_x, yerr=err_l*100, color='lightseagreen', label='Dati sperimentali', fmt='.', markersize=0)
plt.xlabel('$T^2 /4 \pi [s^2]$')
plt.ylabel('Lunghezza [cm]')
